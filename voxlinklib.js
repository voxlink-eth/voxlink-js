            ...
            start: async function (options) {
                ...
                return new Promise(async (resolve, reject) => {
                    ...
                    if (success) {
                        ...
                        modalTitle.innerHTML = "GhostMinting by Voxlink";
                        ...
                        modalDescription.innerHTML = "You have connected a Voxlink burner wallet.<br>Your main wallet has automatically been detected. The NFT will be sent to your main wallet: <a title='" + mainWallet + "' href='https://goerli.etherscan.io/address/" + mainWallet + "' target='_blank'>" + shortenedWallet + "</a><br>";
                        modalDescription.innerHTML += "<span id='modalVoxlinkGhostmintingCountdown'>&nbsp;</span><br><br>";
                        modalDescription.innerHTML += '<button onclick="Voxlink.ghostminting.mint()" style="font-size:1.25rem;padding-right:1rem;padding-left:1rem;font-weight:bold;border-radius:9999px;background:#7DD3FC;color:#1E3A8A;margin-right:10px;">Mint now</button>';
                        modalDescription.innerHTML += '<button onclick="Voxlink.ghostminting.cancel()" style="font-size:1.25rem;padding-right:1rem;padding-left:1rem;font-weight:bold;border-radius:9999px;background:#7DD3FC;color:#1E3A8A;margin-right:10px;">Cancel</button>';
                        modalDescription.innerHTML += '<button onclick="Voxlink.ghostminting.switchToBurner()" style="font-size:1.25rem;padding-right:1rem;padding-left:1rem;font-weight:bold;border-radius:9999px;background:#7DD3FC;color:#1E3A8A;">Send to burner</button>';
                        ...
                        var countdown = setInterval(function () {
                            modalDescription.querySelector("#modalVoxlinkGhostmintingCountdown").innerHTML = "Minting in " + count + " seconds... <button href='#' style='text-decoration:underline' onclick='Voxlink.ghostminting.pauseCountdown()'>pause</button>";
                            if (count == 0) {
